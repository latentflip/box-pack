...
var RegionManager = AmpersandView.extend({
    ...
    registerCollectionViewEvents: function () {
        ...
        this.listenTo(this.collectionView, 'childview:inserted', function (view) {
            ...
            view.events.dragstart = 'regionOnDragStart';
            view.events.dragend = 'regionOnDragEnd';
            view.events.dragover = 'regionOnDragOver';
            view.events.drop = 'regionOnDrop';

            if (view.eventManager) {
                view.delegateEvents();
            }

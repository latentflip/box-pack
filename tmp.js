...
setTimeout(function () {
    addNVideos('podium', 4, 10); addNVideos('filmstrip', 20, 10); addNVideos('avatars', 30, 10);
}, 500);

},{"./lib/fit-inside":4,"./solver2":6,"underscore":5}],2:[function(require,module,exports){
module.exports = function area(rect) {
    return rect[0] * rect[1];
}

},{}],3:[function(require,module,exports){
module.exports = function aspectRatio(rect) {
    return rect[0] / rect[1];
};
...
},{"./aspect-ratio":3}],5:[function(require,module,exports){
//     Underscore.js 1.7.0
...
},{"./lib/area":2,"./lib/aspect-ratio":3,"./lib/fit-inside":4,"underscore":5}]},{},[1]);
